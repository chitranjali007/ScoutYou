...
<div id="templatmeo_wrapper">
    ...
    <div id="templatemo_content_wrapper">
        ...
        Validate <a href="http://validator.w3.org/check?uri=referer">XHTML</a> &amp; <a href="http://jigsaw.w3.org/css-validator/check/referer">CSS</a>. Credit goes to <a href="http://www.photovaco.com" target="_blank">Free Photos</a> for photos used in this layout. Nam ut libero at lacus feugiat tincidunt vitae sed ipsum. Vivamus ut ante ullamcorper urna cursus porta.</p>
            ...
            <div class="templatemo_box">
            	<h2><span></span>New Advertisement</h2>
                
                <div class="body">
                    
                    <div class="news_box">
                         <form action="intern_jsp.jsp">
									ADD
									<br/><br/>
									<textarea name="add" required placeholder="enter your add"></textarea><br>
									<br/><br/>
									Company
									<br/><br/>
									 <input type="text" name="company" required placeholder="enter your company-name" ><br>
									<br/><br/>
									Degree
									<br/><br/>
								    <input type="text"  name="degree" required placeholder="enter the degree required"><br>
									<br/><br/>
									Email
								   	<br/><br/>
        	...
        	<div class="templatemo_box">
                ...
                <div class="body">
					...
					<form action="logout.jsp" method="post">
                        <p>
                             <%  String un1=(String)session.getAttribute("user_name");
        		out.print("wecome "+un1);
                           %>
                           <br/><br/>
